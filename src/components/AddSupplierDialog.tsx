  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Handle API error
        setErrors({ name: result.error || 'Failed to add supplier' })
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button className="h-10">Add Supplier</Button>
      </DialogTrigger>
      <DialogContent className="p-7 px-8 poppins min-w-5xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Fill in the form to add a new supplier to your inventory system.
          </DialogDescription>
        </DialogHeader>
        <Separator />
        ...
        <div className="flex flex-col gap-4 mt-1">
          ...
          <div className="space-y-4">
            ...
            {/* Street Address */}
            <div className="flex flex-col gap-2">
              <Label htmlFor="supplier-street">Street Address</Label>
              <Input
                id="supplier-street"
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-2">
                <Label htmlFor="supplier-website">Website (Optional)</Label>
                <Input
                  id="supplier-website"
